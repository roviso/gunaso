      ...
      <div class="flex items-center justify-between h-16">
        ...
        <RouterLink to="/" class="flex items-center gap-2 shrink-0" @click="mobileOpen = false">
          <div class="w-8 h-8 bg-primary rounded-lg flex items-center justify-center shadow-sm">
            <span class="text-white font-extrabold text-sm leading-none">G</span>
          </div>
          <span class="font-extrabold text-lg text-secondary dark:text-white tracking-tight">Gunaso</span>
        </RouterLink>
